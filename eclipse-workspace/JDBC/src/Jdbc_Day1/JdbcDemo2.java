...
//					getConnection is a interface  class
				...
				String user="create table student1(id int Auto_increment primary key,name varchar(100),number int)";
				st.executeUpdate(user);
				System.out.println("Table student1 is created at mysql ");
				String val="insert into student1(name,number) values(?,?)";
